...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if (((voltage * current) / theoretical_max_power) * 100) >= 80:
        return "green"
    if (((voltage * current) / theoretical_max_power) * 100) < 80 and (((voltage * current) / theoretical_max_power) * 100) >= 60:
        return "orange"
    if (((voltage * current) / theoretical_max_power) * 100) <60 and (((voltage * current) / theoretical_max_power) * 100) >= 30:
        return "red"
    return "black"
